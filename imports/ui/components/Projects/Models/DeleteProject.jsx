...
function DeleteProject(props) {
  ...
  let {company, open, handleModalClose, project, activities} = props;
  ...
  const removeProject = () => {
    ...
    activities = activities.filter(activity => activity.projectId === project._id);
    ...
    <div className={classes.createNewProject}>
      <Dialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={open} maxWidth="sm"
        ...
        <DialogContent dividers>
          <DialogContentText>
            Are you sure you want to remove the project <strong>{project.name}</strong> and all related activities? This
